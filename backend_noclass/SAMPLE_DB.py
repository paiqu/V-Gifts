...
def generate_sample_db_0():
    ...
    user_2 = us.new_user('user_2', 'user_2', 'user_2', '123', '123@unsw', 'somewhere', 'city', 'country')
    user_3 = us.new_user('user_3', 'user_3', 'user_3', '123', '123@unsw', 'somewhere', 'city', 'country')
    db.add_user(user_1)
    db.add_user(user_2)
    db.add_user(user_3)
    # prod
